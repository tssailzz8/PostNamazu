    ...
    internal class Command : NamazuModule
    {
        ...
        public void DoTextCommand(string command)
        {
            ...
            try {
               ...
               // = Memory.CallInjected64<int>(ProcessChatBoxPtr, RaptureModule, allocatedMemory.Address, UiModule);
                _ = Memory.CallInjected64<int>(ProcessChatBoxPtr, new object[]
                    {
                        UiModule,allocatedMemory.Address,IntPtr.Zero,0
                    });
            }
            finally {
